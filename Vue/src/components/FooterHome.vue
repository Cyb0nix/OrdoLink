    ...
    <footer class="bg-gray-100">
        <div class="absolute inset-x-0 bottom-0 mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <p class="mx-auto mt-4 max-w-md text-center leading-relaxed text-gray-500">
                Ordolink permet de dématérialiser vos ordonnances, en offrant un accès aux médecins, aux patients et aux pharmaciens.
            </p>
            ...
            <ul class="mt-8 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
                ...
                <li>
                    <a class="text-gray-700 transition hover:text-gray-700/75" href="/">Nos Services</a>
                </li>
